...
(defun espiral-2 (n)
  "crua uma lista com valores duplicados"
  (labels ((espiral-aux (n i &optional lst)
	     (if (= 0 n) 
		 (append i (cdr lst))
		 (espiral-aux (1- n) (list (cons n lst)) (append (cons n lst) lst)))))
    (espiral-aux n 1 '())))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; funcao para inserir zeros numa regiao (ou 'comer tablete'), maximo de tabletes de uma
;;; vez, despreza zeros (casas vazia) dentro de uma mesma regiao
;;;---------------------------------------------------------------------------------------------
